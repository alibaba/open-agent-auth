      ...
      '/docs/architecture/': [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: 'WIMSE + DCR Integration',
              link: '/docs/architecture/09-wimse-dcr-integration',
              collapsed: false,
              items: [
                { text: 'Protocol Foundation', link: '/docs/architecture/09-wimse-dcr-integration#protocol-foundation' },
                { text: 'Architecture Design', link: '/docs/architecture/09-wimse-dcr-integration#architecture-design' },
                { text: 'Phase 1: Credential Bootstrap', link: '/docs/architecture/09-wimse-dcr-integration#phase-1-credential-bootstrap-wit-acquisition' },
                { text: 'Phase 2: DCR Registration', link: '/docs/architecture/09-wimse-dcr-integration#phase-2-dynamic-client-registration-dcr-with-software-statement' },
                { text: 'Phase 3: private_key_jwt Auth', link: '/docs/architecture/09-wimse-dcr-integration#phase-3-authenticated-operations-private_key_jwt' },
                { text: 'Implementation Details', link: '/docs/architecture/09-wimse-dcr-integration#implementation-details' },
                { text: 'Key Rotation & Lifecycle', link: '/docs/architecture/09-wimse-dcr-integration#key-rotation-and-credential-lifecycle' },
                { text: 'Security Considerations', link: '/docs/architecture/09-wimse-dcr-integration#security-considerations' },
