...
/**
 * Base exception for all OAuth2 domain exceptions (OAuth2 Protocol).
 * <p>
 * This exception serves as the root for all exceptions in the OAuth2 domain.
 * All OAuth2-related exceptions should extend from this class.
 * </p>
 * <p>
 * <b>Domain Code:</b> 04
 * </p>
...
public abstract class OAuth2Exception extends FrameworkException {
    ...
    /**
     * Constructs a new OAuth2 exception with the specified error code and parameters.
     *
    ...
    /**
     * Constructs a new OAuth2 exception with the specified error code, cause, and parameters.
     *
     * @param errorCode the error code
