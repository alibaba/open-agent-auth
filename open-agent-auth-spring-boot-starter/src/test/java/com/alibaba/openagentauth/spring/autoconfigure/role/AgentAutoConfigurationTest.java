...
class AgentAutoConfigurationTest {
    ...
    private final WebApplicationContextRunner contextRunner = new WebApplicationContextRunner()
        ...
        .withPropertyValues(
            ...
            "open-agent-auth.capabilities.operation-authorization.agent-context.default-device-fingerprint=test-device",
        ...
        void shouldBindOperationAuthorizationPropertiesWithNewStructure() {
            contextRunner
                ...
                .run(context -> {
                    ...
                    assertThat(properties.getCapabilities().getOAuth2Client().getClientId()).isEqualTo("test-client-id");
