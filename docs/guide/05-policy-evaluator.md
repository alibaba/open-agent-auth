...
For more information, refer to the [Configuration Guide](04-configuration.md), [Quick Start Guide](01-quick-start.md), and [User Guide](01-quick-start.md). You may also want to check the [IETF Draft for Agent Operation Authorization](https://datatracker.ietf.org/doc/draft-liu-agent-operation-authorization/) and the [OPA Documentation](https://www.openpolicyagent.org/docs/latest/) for additional context and best practices.
